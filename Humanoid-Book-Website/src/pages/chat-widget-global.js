...
function GlobalChatWidgetContent() {
  useEffect(() => {
    ...
    return () => {
      const buttonContainer = document.getElementById('global-chat-button');
...
function GlobalChatWidgetPage() {
  return (
    <BrowserOnly>
      {() => <GlobalChatWidgetContent />}
    </BrowserOnly>
  );
}

export default GlobalChatWidgetPage;